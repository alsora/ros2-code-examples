...
#include "simple_memory_test/msg/array300kb.hpp"
...
public:
    ...
    SimpleSubscriberNode(std::string name) : Node(name)
    {
        ...
        _sub = this->create_subscription<simple_memory_test::msg::Array300kb>( "chatter",
...
private:
    ...
    void simple_callback(const simple_memory_test::msg::Array300kb::SharedPtr msg)
    {
        (void)msg;
    }

    rclcpp::Subscription<simple_memory_test::msg::Array300kb>::SharedPtr _sub;
