...
#include "simple_memory_test/msg/array250kb.hpp"
...
public:
    ...
    SimpleSubscriberNode(std::string name) : Node(name)
    {
        ...
        _sub = this->create_subscription<simple_memory_test::msg::Array250kb>( "chatter",
...
private:
    ...
    void simple_callback(const simple_memory_test::msg::Array250kb::SharedPtr msg)
    {
        (void)msg;
    }

    rclcpp::Subscription<simple_memory_test::msg::Array250kb>::SharedPtr _sub;
