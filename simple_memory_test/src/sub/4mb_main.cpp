...
#include "simple_memory_test/msg/array4mb.hpp"
...
public:
    ...
    SimpleSubscriberNode(std::string name) : Node(name)
    {
        ...
        _sub = this->create_subscription<simple_memory_test::msg::Array4mb>( "chatter",
...
private:
    ...
    void simple_callback(const simple_memory_test::msg::Array4mb::SharedPtr msg)
    {
        (void)msg;
    }

    rclcpp::Subscription<simple_memory_test::msg::Array4mb>::SharedPtr _sub;
