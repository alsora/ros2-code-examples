...
#include "simple_memory_test/msg/array10b.hpp"
...
public:
    ...
    SimpleSubscriberNode(std::string name) : Node(name)
    {
        ...
        _sub = this->create_subscription<simple_memory_test::msg::Array10b>( "chatter",
...
private:
    ...
    void simple_callback(const simple_memory_test::msg::Array10b::SharedPtr msg)
    {
        (void)msg;
    }

    rclcpp::Subscription<simple_memory_test::msg::Array10b>::SharedPtr _sub;
