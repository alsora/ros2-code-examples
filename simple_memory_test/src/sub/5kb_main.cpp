...
#include "simple_memory_test/msg/array5kb.hpp"
...
public:
    ...
    SimpleSubscriberNode(std::string name) : Node(name)
    {
        ...
        _sub = this->create_subscription<simple_memory_test::msg::Array5kb>( "chatter",
...
private:
    ...
    void simple_callback(const simple_memory_test::msg::Array5kb::SharedPtr msg)
    {
        (void)msg;
    }

    rclcpp::Subscription<simple_memory_test::msg::Array5kb>::SharedPtr _sub;
