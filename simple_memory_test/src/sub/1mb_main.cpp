...
#include "simple_memory_test/msg/array1mb.hpp"
...
public:
    ...
    SimpleSubscriberNode(std::string name) : Node(name)
    {
        ...
        _sub = this->create_subscription<simple_memory_test::msg::Array1mb>( "chatter",
...
private:
    ...
    void simple_callback(const simple_memory_test::msg::Array1mb::SharedPtr msg)
    {
        (void)msg;
    }

    rclcpp::Subscription<simple_memory_test::msg::Array1mb>::SharedPtr _sub;
