...
#include "simple_memory_test/msg/array750kb.hpp"
...
public:
    ...
    SimpleSubscriberNode(std::string name) : Node(name)
    {
        ...
        _sub = this->create_subscription<simple_memory_test::msg::Array750kb>( "chatter",
...
private:
    ...
    void simple_callback(const simple_memory_test::msg::Array750kb::SharedPtr msg)
    {
        (void)msg;
    }

    rclcpp::Subscription<simple_memory_test::msg::Array750kb>::SharedPtr _sub;
