...
#include "simple_memory_test/msg/array450kb.hpp"
...
public:
    ...
    SimpleSubscriberNode(std::string name) : Node(name)
    {
        ...
        _sub = this->create_subscription<simple_memory_test::msg::Array450kb>( "chatter",
...
private:
    ...
    void simple_callback(const simple_memory_test::msg::Array450kb::SharedPtr msg)
    {
        (void)msg;
    }

    rclcpp::Subscription<simple_memory_test::msg::Array450kb>::SharedPtr _sub;
